...
This folder contains a curated 7,751-paper sample from all arXiv API records
...
whose primary category was in Astrophysics, Condensed Matter, or Economics were
removed.
...
all papers whose primary category is in Astrophysics, Condensed Matter, or
Economics. This is a metadata quality filter, not a judgment of scientific
validity.
...
Run `paper-fetcher-validity --expected-count 7751` from the repository root to
...
No full-text PDFs are stored for these 7,751 papers. The output therefore does
