...
| Track hot and emerging topics | Equal recent and baseline windows use mean per-source document shares. Emerging score requires at least three recent documents and positive smoothed log growth. | Trend status is `ok` with seven-day windows ending August 6, 2026. No topic met both the three-document minimum and positive-growth condition in the active mixed-source snapshot. |
